                    ...
                    ?>
                      <div class="task">
                        <a href="<? echo base_url('dashboard/schedules') ?>" style="color:black">
                          <label for="item-1">
                            <span class="label-text"><? echo date("m-d-Y", strtotime($u->start_time)) . " (" . date("h:iA", strtotime($u->start_time)) . "-" . date("h:iA", strtotime($u->end_time)) . ")" ?></span>
                          </label>
                        </a>
                    ...
                    ?>
                      <div class="task">
                        <a href="<? echo base_url('dashboard/documents') ?>" style="color:black">
                          <label for="item-1">
                            <span class="label-text"><? echo $d->document_type ?></span>
                          </label>
                        </a>
                        <!-- <span class="tag approved">Approved</span> -->
                      </div>
